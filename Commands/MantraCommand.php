 ...
 */
class MantraCommand extends UserCommand
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    protected $description = 'Show bot mantras commands help';
    /**
     * @var string
     */
    protected $usage = '/mantra or /mantra <command>';
    /**
     * @var string
     */
    ...
    public function execute()
    {
        ...
        if ($command_str === '') {
            ...
            $data['text'] .= PHP_EOL . 'For exact command help type: /mantra <command>';
