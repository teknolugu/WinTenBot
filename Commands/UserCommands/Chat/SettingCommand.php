...
//                ]);
		    ...
		    $chatHandler->sendText('🔄 Loading settings..', '-1');
		    $chatHandler->deleteMessage();
		    $btns = Settings::getForTombol($chat_id, $chatHandler->isPrivateChat);
		    $btn_markup = [];
		    ...
		    $r = $chatHandler->editText($text, null, $btn_markup);
		    $chatHandler->deleteMessage($group_data[0]['last_setting_message_id']);
		    Settings::saveNew([
